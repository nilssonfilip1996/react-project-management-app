    ...
    <>
      <div className="flex flex-row my-36">
        <div className="basis-1/4">
          <Sidebar projectNames={Object.keys(projects)} handleViewProject={viewProject} handleStartNewProject={handleStartNewProject}/>
        </div>
        <div className="basis-2/5">
          <Content handleSave={addNewProject} handleCancel={handleCancel} handleStartNewProject={handleStartNewProject} manageTask={manageTask} contentView={contentView} chosenProject={chosenProject}/>  
        </div>
      </div>
    </>
  );

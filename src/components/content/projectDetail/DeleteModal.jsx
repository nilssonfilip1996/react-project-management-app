                ...
                <div className="fixed inset-0 grid place-content-center bg-black/90">
                    <div className="w-full max-w-lg bg-white p-4 shadow-lg rounded-lg">
                        ...
                        <div className="flex flex-row justify-center mt-4 gap-4">
                            <button className="px-2 text-stone-800 bg-red-200 hover:bg-red-400 rounded-md" onClick={handleDelete}>Yes</button>
                            <button className="px-2 text-stone-800 bg-green-200 hover:bg-green-400 rounded-md" onClick={() => dialog.current.close()}>No</button>
                        </div>
                    </div>
                </div>
            </dialog>

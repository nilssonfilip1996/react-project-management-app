...
export default function Content({chosenProject}) {
...
/*         <div className="flex flex-col py-10 items-center">
            ...
            <button className="w-fit mt-6 px-3 py-2 text-lg rounded-xl bg-stone-900 hover:bg-stone-400 text-stone-200" onClick={handleClick}>Create New Project</button>
        </div> */
    )
}